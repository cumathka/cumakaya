        ...
        <ul class="space-y-6">
          ...
          <li class="pt-8 mt-4 border-t border-gray-800 transform transition-all duration-500 delay-300"
            ...
            <div class="flex flex-wrap gap-2">
              <button @click="setLanguage('de')" :class="['px-4 py-2 rounded-lg text-sm font-medium transition-all border',
                currentLang === 'de'
                  ? 'bg-indigo-600 border-indigo-500 text-white shadow-lg shadow-indigo-500/20'
                  : 'bg-slate-800 border-slate-700 text-gray-400 hover:text-white']">DE</button>
              <button @click="setLanguage('en')" :class="['px-4 py-2 rounded-lg text-sm font-medium transition-all border',
                currentLang === 'en'
                  ? 'bg-indigo-600 border-indigo-500 text-white shadow-lg shadow-indigo-500/20'
                  : 'bg-slate-800 border-slate-700 text-gray-400 hover:text-white']">EN</button>
              <button @click="setLanguage('fr')" :class="['px-4 py-2 rounded-lg text-sm font-medium transition-all border',
                currentLang === 'fr'
                  ? 'bg-indigo-600 border-indigo-500 text-white shadow-lg shadow-indigo-500/20'
                  : 'bg-slate-800 border-slate-700 text-gray-400 hover:text-white']">FR</button>
              <button @click="setLanguage('tr')" :class="['px-4 py-2 rounded-lg text-sm font-medium transition-all border',
                currentLang === 'tr'
                  ? 'bg-indigo-600 border-indigo-500 text-white shadow-lg shadow-indigo-500/20'
