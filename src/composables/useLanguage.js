...
const translations = {
  de: {
    ...
    about: {
      ...
      p1: "Junior Full Stack Developer mit AWS Cloud Practitioner Zertifizierung. Leidenschaftlich für moderne Webtechnologien (Vue.js, Node.js, AWS Cloud, Java (Spring), React, Angular, MySQL, Cybersecurity, Ethical Hacking) und Cloud-Lösungen.",
      p2: "Mit einem KI-gestützten Entwicklungsansatz nutze ich GitHub Copilot und moderne Webtechnologien, um hochperformante und skalierbare Webanwendungen zu erstellen. Mit Stacks wie Vue.js, Node.js, AWS Cloud, Java (Spring), React, Angular, MySQL, Cybersecurity, Ethical Hacking liefere ich schnelles Prototyping und produktionsreife Lösungen. Codequalität, nachhaltige Architektur und Benutzererfahrung stehen dabei an erster Stelle.",
      location: "Standort",
      email: "E-Mail",
      phone: "Telefon",
      languages: "Sprachen",
  ...
  en: {
    ...
    about: {
      ...
      p1: "Junior Full Stack Developer with AWS Cloud Practitioner Certification. Passionate about modern web technologies (Vue.js, Node.js, AWS Cloud, Java (Spring), React, Angular, MySQL, Cybersecurity, Ethical Hacking) and cloud solutions.",
      p2: "I use an AI-supported development approach with GitHub Copilot and modern web technologies to build high-performance, scalable web applications. Utilizing stacks like Vue.js, Node.js, AWS Cloud, Java (Spring), React, Angular, MySQL, Cybersecurity, Ethical Hacking, I deliver rapid prototyping and production-ready solutions. My priorities are code quality, sustainable architecture, and exceptional user experience.",
      location: "Location",
      email: "Email",
      phone: "Phone",
      languages: "Languages",
  ...
  fr: {
    ...
    about: {
      ...
      p1: "Développeur Full Stack Junior certifié AWS Cloud Practitioner. Passionné par les technologies web modernes (Vue.js, Node.js, AWS Cloud, Java (Spring), React, Angular, MySQL, Cybersecurity, Ethical Hacking) et les solutions cloud.",
      p2: "J'utilise une approche de développement assistée par l'IA avec GitHub Copilot et des technologies web modernes pour créer des applications performantes et évolutives. Avec des stacks comme Vue.js, Node.js, AWS Cloud, Java (Spring), React, Angular, MySQL, Cybersecurity, Ethical Hacking, je produis des prototypages rapides et des solutions prêtes pour la production. La qualité du code, l'architecture durable et l'expérience utilisateur sont mes priorités.",
      location: "Lieu",
      email: "E-mail",
      phone: "Téléphone",
      languages: "Langues",
  ...
  tr: {
    ...
    about: {
      ...
      p1: "AWS Cloud Practitioner sertifikalı Junior Full Stack Geliştirici. Modern web teknolojileri (Vue.js, Node.js, AWS Cloud, Java (Spring), React, Angular, MySQL, Cybersecurity, Ethical Hacking) ve bulut çözümleri konusunda tutkuluyum.",
      p2: "AI destekli geliştirme yaklaşımıyla, GitHub Copilot ve modern web teknolojilerini kullanarak yüksek performanslı, ölçeklenebilir web uygulamaları geliştiriyorum. Vue.js, Node.js, AWS Cloud, Java (Spring), React, Angular, MySQL, Cybersecurity, Ethical Hacking gibi modern stack’lerle hem hızlı prototipleme hem de production-ready çözümler sunuyorum. Önceliğim her zaman kod kalitesi, sürdürülebilir mimari ve kullanıcı deneyimidir.",
      location: "Konum",
      email: "E-posta",
      phone: "Telefon",
      languages: "Diller",
